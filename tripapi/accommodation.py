            ...
            "rooms": [
                {
                    ...
                    "name": "Deluxe King",
                    "price": "$250",
                    "features": "King Bed, City View, Bathtub",
                },
                {
                    "id": "r1b",
                    "name": "Twin Suite",
                    "price": "$320",
                    "features": "2 Queen Beds, Living Area, Balcony",
                },
            ],
        },
        {
            ...
            "rooms": [
                {
                    ...
                    "name": "8-Bed Dorm",
                    "price": "$25",
                    "features": "Bunk Bed, Shared Bath, Reading Light",
                },
                {
                    "id": "r2b",
                    "name": "Private Double",
                    "price": "$60",
                    "features": "Double Bed, Shared Bath, Desk",
                },
            ],
        },
        {
            ...
            "rooms": [
                {
                    ...
                    "name": "Garden Room",
                    "price": "$85",
                    "features": "Queen Bed, En-suite, Garden Access",
                },
                {
                    "id": "r3b",
                    "name": "Attic Loft",
                    "price": "$75",
                    "features": "Double Bed, Skylight, Cozy",
                },
            ],
        },
        {
            ...
            "rooms": [
                {
                    ...
                    "name": "Single Pod",
                    "price": "$40",
                    "features": "Privacy Blind, USB Charging, Vent",
                }
            ],
        },
    ]
